            ...
            },
            {
                ...
                "encoding": {
                    ...
                    "tooltip": [
                        ...
                        {"field": "lower", "type": "quantitative", "title": "Bootstrap 2.5%", "format": ".3f"},
                        {"field": "upper", "type": "quantitative", "title": "Bootstrap 97.5%", "format": ".3f"},
...
if st.button(
    ...
    if not traj_df.empty:
        ...
        st.caption(
            "One selected recording file. Faint lines are individual tokens; the thick line is the condition median; the band is a pointwise 95% bootstrap interval."
        )
        cue_labels = {
            "A1_P0_dB": "A1-P0 (dB)",
        ...
        st.caption(
            "Each file is z-scored using oral CVC tokens as reference. Faint lines are individual tokens; thick lines and bands summarise the pooled reference data."
        )
        for cue in selected_core_cues:
            token_curves, summary = trajectory_plot_components(
                traj_df,
